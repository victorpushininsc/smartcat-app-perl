...
isa_ok( $app->document_export_api->{api}, 'Smartcat::Client::DocumentExportApi' );


is_deeply(
  [ sort $app->command_names ],
  [ sort qw(--help --version -? -h account commands config document help project pull push version) ],
